...
# Student.all and Cohort.all
# Student.create and Cohort.create
# Student.where and Cohort.where
# Student.find and Cohort.find
# Student.new_record? and Cohort.new_record?
# Student.insert! and Cohort.insert!
# Student.update! and Cohort.update!
...
# # alishas = Student.where('first_name = ?', 'Alisha')
# alishas.first[:first_name]
